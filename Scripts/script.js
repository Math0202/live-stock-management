    ...
    modal.innerHTML = `
        <div class="modal-content">
            ...
            <form id="addAnimalForm">
                ...
                <div>
                    <label for="newCamp">Initial Camp:</label>
...
async function handleAddAnimal(e) {
    ...
    try {
        const formData = {
            ...
            currentCamp: document.getElementById('newCamp').value // Added currentCamp here
        };

        // Validate required fields
        if (!formData.tag_number || !formData.type || !formData.dob || !formData.slaughterAge || !formData.vaccineType || !formData.currentCamp) {
        ...
        if (result.success) {
            updateAnimalTable({
                ...
                current_camp: formData.currentCamp // Added current_camp here
            });
...
// Data structure for rotation history (using localStorage for persistence)
function getRotationHistory() {
    const history = localStorage.getItem('rotationHistory');
